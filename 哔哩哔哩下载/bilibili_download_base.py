...
# 复写类的方法
    ...
    def p(self, stream_id=None):
        # maybe_print("site xyy:                %s" % self.__class__.name)
        # maybe_print("title xyy:               %s" % self.title)
        # if stream_id:
        #     # Print the stream
        #     print("stream:")
    ...
    def download_by_url(self, url, **kwargs):
        ...
        self.extract(**kwargs)
        # print("xyy 爱奇艺脚本修改复写 kwargs:{}".format(kwargs))
    ...
    def download(self, **kwargs):
        if 'json_output' in kwargs and kwargs['json_output']:
            ...
            # print(f"ppppppp urls:{urls} title:{self.title},ext:{ext},outputdir:{kwargs['output_dir']}")
            # print(self.streams)
            # print(self.m3u8_url)
            # urls = urls[-1]
            # new_md5 = hashlib.md5()
            # new_md5.update(self.url.encode())
            # url_hash = new_md5.hexdigest()
            # back_info = {"output_dir":kwargs["output_dir"],"down_load_url":urls,"url":self.url,"url_hash":url_hash,"video_title":self.title}
            # back_info = {"down_load_url_list":urls}
            # print(back_info)
            # return back_info
            # print(self.title)
            # print(kwargs)
            ...
            # print(urls, kwargs["title"], ext, total_size, headers,
            #               "/Users/quanlifang/Desktop/和晞科技/hexikeji_all/video_compar_zhuanxiang_bili_v001/tort_download_unit/te.mp4",
            #               kwargs['merge'],av
            #               )
            file_title = kwargs["title"]
            # print(urls, file_title, ext, total_size,)
            # urls = [['http://cn-sdbz-cu-v-04.bilivideo.com/upgcxcode/15/58/26805815/26805815_da3-1-30032.m4s?expires=1599214894&platform=pc&ssig=sxaZ8XS2xFCvItLyK1ND_g&oi=2071626969&trid=8d267721e0d24c3b8f896bd040c8ccfau&nfc=1&nfb=maPYqpoel5MI3qOUX6YpRA==&cdnid=9453&mid=0&cip=222.134.1.69&orderid=0,3&agrr=1&logo=80000000'], ['http://upos-sz-mirrorcos.bilivideo.com/upgcxcode/15/58/26805815/26805815_da3-1-30216.m4s?e=ig8euxZM2rNcNbdlhoNvNC8BqJIzNbfqXBvEqxTEto8BTrNvN0GvT90W5JZMkX_YN0MvXg8gNEV4NC8xNEV4N03eN0B5tZlqNxTEto8BTrNvNeZVuJ10Kj_g2UB02J0mN0B5tZlqNCNEto8BTrNvNC7MTX502C8f2jmMQJ6mqF2fka1mqx6gqj0eN0B599M=&uipk=5&nbs=1&deadline=1599214894&gen=playurl&os=cosbv&oi=2071626969&trid=8d267721e0d24c3b8f896bd040c8ccfau&platform=pc&upsig=966fefbc7b37f7df784a07e0157489d6&uparams=e,uipk,nbs,deadline,gen,os,oi,trid,platform&mid=0&orderid=0,3&agrr=1&logo=80000000']]
            # print(headers,"xyyyheaders")

            download_urls(urls, file_title, ext, total_size, headers=headers,
                          output_dir=kwargs['output_dir'],
                          merge=kwargs['merge'],
                          av=stream_id in self.dash_streams
                          )
...
if __name__ == '__main__':
    # download(url='https://www.bilibili.com/video/BV1Jv411z7wv?spm_id_from=333.851.b_7265706f7274466972737431.13', **{"info_only": False,
    #                                                                              "output_dir": r'/Users/quanlifang/PycharmProjects/video_platform_qlf/video_demo_test/ai_qi_yi_test_video_',
    #                                                                              "merge": True})

    # 测试
    # download(url='https://www.bilibili.com/video/BV1NW411m7ag?from=search&seid=989232082964661405', **{"info_only": False,
    #                                                                              "output_dir": r'/Users/quanlifang/PycharmProjects/video_platform_qlf/video_demo_test/ai_qi_yi_test_video_',
    #             av16431951             av37366708（分离）                                                     "merge": True})
    download(url='http://www.bilibili.com/video/av16431951', **{"info_only": False,
                                                                                 "output_dir": '/Users/quanlifang/Desktop/和晞科技/hexikeji_all/video_compar_zhuanxiang_bili_v001/tort_download_unit',
                                                                                 "merge": True,"title":"xx"})
