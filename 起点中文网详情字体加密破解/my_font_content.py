...
if __name__ == '__main__':
	with open("/Users/quanlifang/Desktop/my_git_file/Python_Spider_All/起点中文网详情字体加密破解/FkMwMtuL.ttf", 'br') as f:
		# print(f.read())
		info = f.read()
		xx = XYYTTFont(file=info)

		print(xx.getGlyphOrder())
		print(xx.getBestCmap())